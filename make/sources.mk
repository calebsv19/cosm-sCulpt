...
CORE_SRCS := $(CORE_BASE_DIR)/src/core_base.c $(CORE_IO_DIR)/src/core_io.c $(CORE_DATA_DIR)/src/core_data.c $(CORE_PACK_DIR)/src/core_pack.c $(CORE_MATH_DIR)/src/core_math.c $(CORE_TIME_SRCS) $(CORE_MESH_ASSET_DIR)/src/core_mesh_asset.c $(CORE_MESH_ASSET_DIR)/src/core_mesh_asset_authoring_document.c $(CORE_MESH_ASSET_DIR)/src/core_mesh_asset_runtime_document.c $(CORE_MESH_COMPILE_DIR)/src/core_mesh_compile.c $(CORE_MESH_COMPILE_DIR)/src/core_mesh_compile_imported_mesh.c $(CORE_MESH_PREVIEW_DIR)/src/core_mesh_preview.c $(CORE_SCENE_DIR)/src/core_scene.c $(CORE_SCENE_VIEW_DIR)/src/core_scene_view.c $(CORE_SCENE_COMPILE_DIR)/src/core_scene_compile.c $(CORE_OBJECT_DIR)/src/core_object.c $(CORE_UNITS_DIR)/src/core_units.c $(CORE_LAYOUT_DIR)/src/core_layout.c $(CORE_PANE_DIR)/src/core_pane.c $(CORE_PANE_MODULE_DIR)/src/core_pane_module.c $(CORE_THEME_DIR)/src/core_theme.c $(CORE_FONT_DIR)/src/core_font.c

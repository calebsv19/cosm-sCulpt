...
WARN_FLAGS := -Wall -Wextra -Werror -Wpedantic -Wno-unknown-attributes -Wno-attributes -Wno-c23-extensions
BASE_CFLAGS := $(WARN_FLAGS) -std=c11 $(ARCH_FLAGS) -Iinclude -Isrc -Isrc/Tools -Iexternal -I$(VK_RENDERER_DIR)/include -I$(KIT_RENDER_DIR)/include -I$(KIT_PANE_DIR)/include -I$(KIT_VIEWPORT3D_DIR)/include -I$(KIT_WORKSPACE_AUTHORING_DIR)/include -I$(CORE_BASE_DIR)/include -I$(CORE_IO_DIR)/include -I$(CORE_DATA_DIR)/include -I$(CORE_MATH_DIR)/include -I$(CORE_TIME_DIR)/include -I$(CORE_MESH_ASSET_DIR)/include -I$(CORE_MESH_COMPILE_DIR)/include -I$(CORE_MESH_PREVIEW_DIR)/include -I$(CORE_SCENE_DIR)/include -I$(CORE_SCENE_VIEW_DIR)/include -I$(CORE_SCREEN_PICK_DIR)/include -I$(CORE_VIEWPORT3D_DIR)/include -I$(CORE_SCENE_COMPILE_DIR)/include -I$(CORE_OBJECT_DIR)/include -I$(CORE_UNITS_DIR)/include -I$(CORE_LAYOUT_DIR)/include -I$(CORE_PANE_DIR)/include -I$(CORE_PANE_MODULE_DIR)/include -I$(CORE_PACK_DIR)/include -I$(CORE_TRACE_DIR)/include -I$(CORE_THEME_DIR)/include -I$(CORE_FONT_DIR)/include -I$(TIMER_HUD_DIR)/include $(SDL_CFLAGS)

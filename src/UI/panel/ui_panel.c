...
void UIPanel_Init(int screenW, int screenH) {
    ...
    yR += btnH + spacing;
    AddButton(&g_uiPanel, "+Light Path", xR, yR, rightBtnW, btnH, UI_PANEL_RIGHT, UI_PANEL_GROUP_RIGHT_OPERATIONS, UI_BTN_CREATE_LIGHT_PATH);
    yR += btnH + spacing;
    AddButton(&g_uiPanel, "+Generic Path", xR, yR, rightBtnW, btnH, UI_PANEL_RIGHT, UI_PANEL_GROUP_RIGHT_OPERATIONS, UI_BTN_CREATE_GENERIC_PATH);
    yR += btnH + spacing;
    ...
    yR += btnH + spacing;
    AddButton(&g_uiPanel, "Roll: 0", xR, yR, rightBtnW, btnH, UI_PANEL_RIGHT, UI_PANEL_GROUP_RIGHT_GIZMO, UI_BTN_SCENE_AUTHORING_CAMERA_ROLL);
    yR += btnH + spacing;
    AddButton(&g_uiPanel, "FOV: 50", xR, yR, rightBtnW, btnH, UI_PANEL_RIGHT, UI_PANEL_GROUP_RIGHT_GIZMO, UI_BTN_SCENE_AUTHORING_CAMERA_FOV);
    yR += btnH + spacing;
    AddButton(&g_uiPanel, "Clip: 0.1 / 250", xR, yR, rightBtnW, btnH, UI_PANEL_RIGHT, UI_PANEL_GROUP_RIGHT_GIZMO, UI_BTN_SCENE_AUTHORING_CAMERA_CLIP);
    yR += btnH + spacing;
    AddButton(&g_uiPanel, "Play", xR, yR, rightBtnW, btnH, UI_PANEL_RIGHT, UI_PANEL_GROUP_RIGHT_GIZMO, UI_BTN_SCENE_AUTHORING_PATH_PLAY);
    yR += btnH + spacing;
    AddButton(&g_uiPanel, "Scrub +25%", xR, yR, rightBtnW, btnH, UI_PANEL_RIGHT, UI_PANEL_GROUP_RIGHT_GIZMO, UI_BTN_SCENE_AUTHORING_PATH_SCRUB);
    yR += btnH + spacing;
    AddButton(&g_uiPanel, "Playback: once", xR, yR, rightBtnW, btnH, UI_PANEL_RIGHT, UI_PANEL_GROUP_RIGHT_GIZMO, UI_BTN_SCENE_AUTHORING_PATH_PLAYBACK_MODE);
    yR += btnH + spacing;
    AddButton(&g_uiPanel, "Duration: 5 s", xR, yR, rightBtnW, btnH, UI_PANEL_RIGHT, UI_PANEL_GROUP_RIGHT_GIZMO, UI_BTN_SCENE_AUTHORING_PATH_DURATION);
    yR += btnH + spacing;
    AddButton(&g_uiPanel, "Path: open", xR, yR, rightBtnW, btnH, UI_PANEL_RIGHT, UI_PANEL_GROUP_RIGHT_GIZMO, UI_BTN_SCENE_AUTHORING_PATH_CLOSED);
    yR += btnH + spacing;
    AddButton(&g_uiPanel, "Position: independent", xR, yR, rightBtnW, btnH, UI_PANEL_RIGHT, UI_PANEL_GROUP_RIGHT_GIZMO, UI_BTN_SCENE_AUTHORING_LIGHT_POSITION_MODE);
    yR += btnH + spacing;
    AddButton(&g_uiPanel, "Light Color", xR, yR, rightBtnW, btnH, UI_PANEL_RIGHT, UI_PANEL_GROUP_RIGHT_GIZMO, UI_BTN_SCENE_AUTHORING_LIGHT_COLOR);
    yR += btnH + spacing;
    AddButton(&g_uiPanel, "Intensity: 1", xR, yR, rightBtnW, btnH, UI_PANEL_RIGHT, UI_PANEL_GROUP_RIGHT_GIZMO, UI_BTN_SCENE_AUTHORING_LIGHT_INTENSITY);
    yR += btnH + spacing;
    AddButton(&g_uiPanel, "Radius: 0.25", xR, yR, rightBtnW, btnH, UI_PANEL_RIGHT, UI_PANEL_GROUP_RIGHT_GIZMO, UI_BTN_SCENE_AUTHORING_LIGHT_SIZE);
    yR += btnH + spacing;
    AddButton(&g_uiPanel, "Cone: 25 / 40", xR, yR, rightBtnW, btnH, UI_PANEL_RIGHT, UI_PANEL_GROUP_RIGHT_GIZMO, UI_BTN_SCENE_AUTHORING_LIGHT_CONE);
    yR += btnH + spacing;
    AddButton(&g_uiPanel, "Falloff: inverse square", xR, yR, rightBtnW, btnH, UI_PANEL_RIGHT, UI_PANEL_GROUP_RIGHT_GIZMO, UI_BTN_SCENE_AUTHORING_LIGHT_FALLOFF);
    yR += btnH + spacing;

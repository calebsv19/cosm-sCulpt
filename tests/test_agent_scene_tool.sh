...
require_pattern '"object_id"[[:space:]]*:[[:space:]]*"low_poly_sphere"' "$MESH_OUT_DIR/scene_authoring.json"
require_pattern '"object_type"[[:space:]]*:[[:space:]]*"mesh_asset_instance"' "$MESH_OUT_DIR/scene_authoring.json"
require_pattern '"geometry_ref"[[:space:]]*:' "$MESH_OUT_DIR/scene_authoring.json"
require_pattern '"kind"[[:space:]]*:[[:space:]]*"mesh_asset"' "$MESH_OUT_DIR/scene_authoring.json"
require_pattern '"id"[[:space:]]*:[[:space:]]*"asset_sphere_8x4"' "$MESH_OUT_DIR/scene_authoring.json"
require_pattern '"material_id"[[:space:]]*:[[:space:]]*"mat_low_poly_sphere"' "$MESH_OUT_DIR/scene_authoring.json"
require_pattern '"object_type"[[:space:]]*:[[:space:]]*"mesh_asset_instance"' "$MESH_OUT_DIR/scene_runtime.json"
require_pattern '"mesh_asset_instances"[[:space:]]*:[[:space:]]*1' "$MESH_OUT_DIR/scene_summary.json"
require_pattern '"mesh_assets_copied"[[:space:]]*:[[:space:]]*1' "$MESH_OUT_DIR/scene_summary.json"
test -f "$MESH_OUT_DIR/assets/mesh_assets/asset_sphere_8x4.runtime.json"
test -f "$LINE_DIR/tmp/agent_low_poly_mesh_sphere/line_drawing_app_load/assets/mesh_assets/asset_sphere_8x4.runtime.json"
test -f "$LINE_DIR/tmp/agent_low_poly_mesh_sphere/agent_low_poly_mesh_sphere.layout.json"
test -f "$LINE_DIR/tmp/agent_low_poly_mesh_sphere/line_drawing_app_load/scene_authoring.json"
test -f "$LINE_DIR/tmp/agent_low_poly_mesh_sphere/line_drawing_app_load/scene_runtime.json"
...
require_pattern '"object_id"[[:space:]]*:[[:space:]]*"imported_skull_proxy"' "$IMPORTED_MATERIAL_OUT_DIR/scene_runtime.json"
require_pattern '"object_type"[[:space:]]*:[[:space:]]*"mesh_asset_instance"' "$IMPORTED_MATERIAL_OUT_DIR/scene_runtime.json"
require_pattern '"object_materials"[[:space:]]*:' "$IMPORTED_MATERIAL_OUT_DIR/scene_runtime.json"
require_pattern '"material_texture_stack"[[:space:]]*:' "$IMPORTED_MATERIAL_OUT_DIR/scene_runtime.json"
require_pattern '"kind"[[:space:]]*:[[:space:]]*"brushed_metal"' "$IMPORTED_MATERIAL_OUT_DIR/scene_runtime.json"
require_pattern '"kind"[[:space:]]*:[[:space:]]*"scratches"' "$IMPORTED_MATERIAL_OUT_DIR/scene_runtime.json"
require_pattern '"kind"[[:space:]]*:[[:space:]]*"grime"' "$IMPORTED_MATERIAL_OUT_DIR/scene_runtime.json"
require_pattern '"mesh_asset_instances"[[:space:]]*:[[:space:]]*1' "$IMPORTED_MATERIAL_OUT_DIR/scene_summary.json"
require_pattern '"mesh_assets_copied"[[:space:]]*:[[:space:]]*1' "$IMPORTED_MATERIAL_OUT_DIR/scene_summary.json"
test -f "$IMPORTED_MATERIAL_OUT_DIR/assets/mesh_assets/asset_imported_tetrahedron_01.runtime.json"
test -f "$LINE_DIR/tmp/agent_imported_mesh_material_prompt/line_drawing_app_load/assets/mesh_assets/asset_imported_tetrahedron_01.runtime.json"
